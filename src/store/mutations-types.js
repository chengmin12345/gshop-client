...
export const RECEIVE_CATEGRORIES='receive_categroies'   //接收食品分类数组
export const RECEIVE_SHOPS='reveice_shops'   //接收商家分类
export const RECEIVE_USER_INFO='reveice_user_info'  //接收用户信息
...
export const RECEIVE_SEARCH_SHOPS ='receive_search_shops'    //接收搜索到的商家信息